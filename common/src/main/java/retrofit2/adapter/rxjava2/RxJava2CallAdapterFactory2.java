...
public final class RxJava2CallAdapterFactory2 extends CallAdapter.Factory {
  ...
  private RxJava2CallAdapterFactory2(@Nullable Scheduler scheduler,  @Nullable Scheduler mainThread,boolean isAsync) {
    this.scheduler = scheduler;
  ...
  @Override public @Nullable CallAdapter<?, ?> get(
    ...
    if (rawType == Completable.class) {
      ...
      return new RxJava2CallAdapter2(Void.class, scheduler, mainScheduler,isAsync, false, true, false, false,
          false, true);
    }
    ...
    return new RxJava2CallAdapter2(responseType, scheduler, mainScheduler,isAsync, isResult, isBody, isFlowable,
        isSingle, isMaybe, false);
  }

  @NotNull
  public static RxJava2CallAdapterFactory2 createWithScheduler(@NotNull Scheduler scheduler, @Nullable Scheduler mainThread) {
    if (scheduler == null) throw new NullPointerException("scheduler == null");
    if (mainThread == null) throw new NullPointerException("mainThread == null");
    return new RxJava2CallAdapterFactory2(scheduler, mainThread,false);
  }
}
