...
final class RxJava2CallAdapter2<R> implements CallAdapter<R, Object> {
  ...
  private final @Nullable Scheduler mainScheduler;
  ...
  RxJava2CallAdapter2(Type responseType, @Nullable Scheduler scheduler, @Nullable Scheduler mainThread, boolean isAsync,
